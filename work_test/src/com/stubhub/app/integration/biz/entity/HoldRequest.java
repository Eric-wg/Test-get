package com.stubhub.app.integration.biz.entity;
...
public class HoldRequest {
		...
		public String toString() {
			return "ReserveRequest [orderId=" + orderId + ", fulfillmentType="
					+ fulfillmentType + ", buyerFirstName=" + buyerFirstName
					+ ", buyerLastName=" + buyerLastName + ", tickets=" + tickets
					+ ", orderTotal=" + orderTotal + ", sellerTotalPayout="
					+ sellerTotalPayout + ", listingId=" + listingId + ", externalListingId="
					+ externalListingId  + "]";
		}
